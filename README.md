...
## Purpose
- This Spring Boot project is configured with following dependencies
  - GraphQL starter
  - JPA
  - H2 runtime
...
- `Altair Edge Browser Extension` is used for Testing
- Following GraphQL API calls are tested:
  - Create Author
  - Create Tutorial
  - Get All Authors
  - Get All Tutorials
